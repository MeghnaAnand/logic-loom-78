    ...
    questions: [
      {
        ...
        options: ["Writing complex code from scratch", "Making a computer repeat tasks you'd normally do by hand", "Replacing all human workers with robots", "Only useful for large companies"],
        correctIndex: 1,
        ...
        concept: "Definition of automation",
      },
      {
        question: "Do you need to know programming to use automation tools?",
        options: ["Yes, you need to be a software engineer", "No, visual tools let you automate without code", "Only if you use Power Automate", "Yes, you must learn Python first"],
        correctIndex: 1,
        ...
        concept: "No-code tools",
      },
      {
        question: "Which of these is a good example of workplace automation?",
        options: ["Manually typing each email reply", "Automatically sending a follow-up email after a form submission", "Reading a report and summarizing it yourself", "Calling each customer individually"],
        correctIndex: 1,
        explanation: "Automating follow-up emails after form submissions is a classic example — the task is repetitive and rule-based.",
        concept: "Real-world automation examples",
      },
      {
        question: "What is a 'workflow' in the context of automation?",
        options: ["A single button click", "A sequence of automated steps that run in order", "A type of spreadsheet", "A programming language"],
        correctIndex: 1,
        explanation: "A workflow is a series of steps that execute automatically in sequence — like dominoes falling one after another.",
        concept: "Workflows",
      },
      {
        question: "What makes automation different from just using software?",
        options: ["Automation costs more money", "Automation runs tasks without you doing them manually each time", "There is no difference", "Automation only works offline"],
        correctIndex: 1,
        explanation: "The key difference is that automation runs on its own after setup — you don't need to manually perform the task each time.",
        concept: "Automation vs manual work",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        options: ["It ends the automation", "It starts the automation when an event happens", "It filters out bad data", "It sends the final notification"],
        correctIndex: 1,
        ...
        concept: "Purpose of triggers",
      },
      {
        question: "Which of these is an example of a trigger?",
        options: ["Sending an email", "Formatting a spreadsheet column", "A new form submission is received", "Creating a PDF report"],
        correctIndex: 2,
      ...
      },
      {
        ...
        options: ["The automation stops", "It passes data to the next step in the workflow", "It deletes the original event", "Nothing until you click a button"],
        correctIndex: 1,
        explanation: "When a trigger fires, it captures event data (like email sender, subject) and passes it forward for the next steps to use.",
        concept: "Data passing from triggers",
      },
      {
        question: "Can an automation work without a trigger?",
        options: ["Yes, actions can run on their own", "No, every automation needs a trigger to start", "Only in Power Automate", "Yes, if you schedule it"],
        correctIndex: 1,
        explanation: "Every automation requires a trigger — even scheduled automations use time as their trigger event.",
        concept: "Trigger requirement",
      },
      {
        question: "Which of these could NOT be a trigger?",
        options: ["A new Slack message", "A spreadsheet row being added", "Formatting text to uppercase", "A scheduled time (e.g., every Monday at 9 AM)"],
        correctIndex: 2,
        explanation: "Formatting text is an action (it does something), not a trigger (an event that starts things). Triggers are events, not operations.",
        concept: "Triggers vs actions",
      },
    ],
  },
  {
    ...
    diagramCaption: "One trigger, three chained actions — data flows through each step",
        ...
        concept: "Definition of actions",
      },
      {
        question: "Can an automation have more than one action?",
        options: ["No, only one action per automation", "Yes, you can chain multiple actions together", "Only if you use a paid plan", "Only two actions maximum"],
        correctIndex: 1,
        ...
        concept: "Chaining actions",
      },
      {
        question: "How do actions get the data they need?",
        options: ["You type it manually each time", "They use data passed from the trigger and previous steps", "They generate random data", "Actions don't use any data"],
        correctIndex: 1,
        explanation: "Actions pull data from earlier steps — the trigger and preceding actions pass information forward through the workflow.",
        concept: "Data flow between actions",
      },
      {
        question: "Which of these is an action?",
        options: ["A new email arrives", "Send a Slack notification", "A form is submitted", "12:00 PM every day"],
        correctIndex: 1,
        explanation: "Sending a Slack notification is performing a task — that's an action. The others are events (triggers).",
        concept: "Identifying actions",
      },
      {
        question: "In the workflow: New Order → Add to Sheet → Send Email → Notify Team, how many actions are there?",
        options: ["1", "2", "3", "4"],
        correctIndex: 2,
        explanation: "There are 3 actions (Add to Sheet, Send Email, Notify Team). 'New Order' is the trigger, not an action.",
        concept: "Counting actions in a workflow",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        concept: "Purpose of conditions",
      },
      {
        question: "In Zapier, what is a condition called?",
        options: ["Module", "Scenario", "Filter or Path", "Connector"],
        correctIndex: 2,
        explanation: "Zapier uses 'Filter' (to stop/continue) and 'Path' (to branch into multiple routes) for conditional logic.",
        concept: "Tool-specific terminology",
      },
      {
        question: "Which scenario best uses a condition?",
        options: ["Send every email to the same folder", "Route urgent tickets to senior staff and low-priority ones to a queue", "Add a row to a spreadsheet", "Wait 5 minutes before the next step"],
        correctIndex: 1,
        ...
        concept: "When to use conditions",
      },
      {
        question: "What happens if a condition evaluates to 'false'?",
        options: ["The automation crashes", "The workflow takes an alternative path or stops that branch", "Nothing, it's ignored", "It retries until it becomes true"],
        correctIndex: 1,
        explanation: "When a condition is false, the workflow either follows an 'else' branch or stops that particular path — it doesn't crash.",
        concept: "False condition behavior",
      },
      {
        question: "How is a condition different from an action?",
        options: ["Conditions perform tasks, actions make decisions", "Conditions make decisions, actions perform tasks", "There is no difference", "Conditions only work with numbers"],
        correctIndex: 1,
        explanation: "Conditions decide (check values, branch paths). Actions do (send emails, update records). They serve different purposes.",
        concept: "Conditions vs actions",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        concept: "Definition of data mapping",
      },
      {
        question: "What is the most common reason automations fail?",
        options: ["The internet goes down", "Wrong data mapped to the wrong fields", "Too many actions in the workflow", "Using free automation tools"],
        correctIndex: 1,
        explanation: "Incorrect data mapping — like putting a name where an email should go — is the #1 cause of automation errors.",
        concept: "Common mapping errors",
      },
      {
        question: "In a 'send welcome email' action, which field should the customer's email address go into?",
        options: ["The 'Subject' field", "The 'Body' field", "The 'To' field", "The 'CC' field"],
        correctIndex: 2,
        explanation: "The customer's email address should be mapped to the 'To' field — that's where the recipient goes.",
        concept: "Correct field mapping",
      },
      {
        question: "Where does the data for mapping come from?",
        options: ["You type it manually every time", "From the trigger and previous steps in the workflow", "From a random generator", "Only from spreadsheets"],
        correctIndex: 1,
        explanation: "Data flows forward — triggers and previous actions produce output data that subsequent steps can map and use.",
        concept: "Data sources in workflows",
      },
      {
        question: "What should you do before running an automation with data mapping?",
        options: ["Delete all the data first", "Double-check that each field is mapped to the correct data", "Run it immediately without checking", "Only map one field at a time"],
        correctIndex: 1,
        explanation: "Always verify your mappings before running — one wrong field can cause the entire workflow to error.",
    ...
    questions: [
      {
        ...
        concept: "When to use loops",
      },
      {
        question: "What does 'iteration' mean?",
        options: ["Stopping an automation", "Going through items in a list one at a time", "Sending a notification", "Mapping data between steps"],
        correctIndex: 1,
      ...
      {
        question: "What is another name for a loop in automation tools?",
        options: ["Trigger", "Iterator or 'for each'", "Webhook", "Filter"],
        correctIndex: 1,
        explanation: "Loops are also called iterators or 'for each' — they all mean the same thing: process each item in a list.",
        concept: "Loop terminology",
      },
      {
        question: "Without loops, how would you process 50 spreadsheet rows?",
        options: ["Build 50 separate automations", "It's impossible", "Use one action that handles everything", "Just ignore the extra rows"],
        correctIndex: 0,
        explanation: "Without loops, you'd need a separate automation for each item — loops eliminate that by handling every item in one workflow.",
        concept: "Why loops matter",
      },
      {
        question: "What does a loop need as input?",
        options: ["A single text value", "A list or collection of items", "A true/false value", "A time schedule"],
        correctIndex: 1,
        explanation: "Loops take a list (of rows, emails, records, etc.) and process each item in that list one at a time.",
        concept: "Loop inputs",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        concept: "Importance of error handling",
      },
      {
        question: "What is a 'try-catch' pattern?",
        options: ["Try one app, then catch the output", "Try an action, and if it fails, catch the error and handle it", "Catch all triggers and try them one by one", "A way to filter data"],
        correctIndex: 1,
        explanation: "Try-catch means: attempt an action (try), and if it fails, execute a fallback or alert (catch) instead of crashing.",
        concept: "Try-catch pattern",
      },
      {
        question: "Which is NOT a common error handling strategy?",
        options: ["Retry the failed step after a delay", "Send an alert when something fails", "Ignore all errors and hope for the best", "Log the error details for debugging"],
        correctIndex: 2,
      ...
      },
      {
        ...
        options: ["Deleting the failed step", "Automatically trying the failed action again after a short delay", "Restarting the entire workflow from scratch", "Sending the error to the user"],
        correctIndex: 1,
        explanation: "Retry logic automatically attempts the failed step again after a delay — useful for temporary issues like API timeouts.",
        concept: "Retry logic",
      },
      {
        question: "What should happen when an automation step fails and can't be retried?",
        options: ["Silently ignore it", "Log the error and notify someone so it can be investigated", "Delete all the data", "Shut down the entire system"],
        correctIndex: 1,
        explanation: "When retries fail, the best practice is to log the error and alert the team so the issue can be diagnosed and fixed.",
        concept: "Fallback and notification",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        concept: "Webhooks vs polling",
      },
      {
        question: "Which is a real-world example of a webhook?",
        options: ["Manually checking your inbox every hour", "Stripe instantly notifying your app when a payment is made", "Copying data from one spreadsheet to another by hand", "Scheduling a report to run at midnight"],
        correctIndex: 1,
        ...
        concept: "Webhook examples",
      },
      {
        question: "What analogy best describes a webhook?",
        options: ["An alarm clock", "A doorbell that rings when someone arrives", "A filing cabinet", "A calculator"],
        correctIndex: 1,
        explanation: "A doorbell notifies you instantly when someone is at the door — just like a webhook notifies your app instantly when an event occurs.",
        concept: "Webhook analogy",
      },
      {
        question: "Why are webhooks more efficient than polling?",
        options: ["They use more server resources", "They only send data when something actually happens, avoiding unnecessary checks", "They're slower but more reliable", "They only work once per day"],
        correctIndex: 1,
        explanation: "Polling wastes resources by checking repeatedly even when nothing changed. Webhooks only fire when there's actual new data.",
        concept: "Webhook efficiency",
      },
      {
        question: "What kind of data does a webhook send?",
        options: ["Only text messages", "Information about the event that just happened", "Random sample data", "Only error messages"],
        correctIndex: 1,
        explanation: "Webhooks send a payload containing details about the event — like payment amount, customer info, or commit details.",
        concept: "Webhook payloads",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        concept: "When to use scheduling",
      },
      {
        question: "Which task is best suited for a scheduled automation?",
        options: ["Responding to a customer message immediately", "Generating a weekly sales report every Monday", "Sending a welcome email when someone signs up", "Routing urgent tickets to the right team"],
        correctIndex: 1,
        explanation: "A weekly sales report runs at a fixed time regardless of events — a perfect use case for a scheduled trigger.",
        concept: "Scheduling use cases",
      },
      {
        question: "What acts as the 'trigger' in a scheduled automation?",
        options: ["A user clicking a button", "A specific time or time interval", "An incoming email", "A database change"],
        correctIndex: 1,
        explanation: "In scheduled automations, time itself is the trigger — the workflow fires when the clock hits the configured interval.",
        concept: "Time as a trigger",
      },
      {
        question: "Which is NOT a good use case for scheduling?",
        options: ["Archiving old files every week", "Sending daily sales summaries", "Instantly responding to a customer complaint", "Syncing data between systems every night"],
        correctIndex: 2,
        explanation: "Instant responses need event-based triggers (like a webhook), not schedules. Schedules are for recurring, non-urgent tasks.",
        concept: "Scheduling vs event triggers",
      },
      {
        question: "What is 'batch processing' in the context of scheduling?",
        options: ["Processing items one at a time in real-time", "Collecting items and processing them all at once at a scheduled time", "Deleting old records", "Sending emails manually"],
        correctIndex: 1,
        explanation: "Batch processing means waiting and handling all accumulated items at once — e.g., processing all new orders at end of day.",
